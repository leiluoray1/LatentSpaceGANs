...
def prepare_sub_folder(output_directory):
    ...
    checkpoint_iter = os.path.join(output_directory, 'checkpoint_iter')
    if not os.path.exists(checkpoint_iter):
        print("Creating directory: {}".format(checkpoint_iter))
        os.makedirs(checkpoint_iter)
    return checkpoint_directory, image_directory, checkpoint_iter
